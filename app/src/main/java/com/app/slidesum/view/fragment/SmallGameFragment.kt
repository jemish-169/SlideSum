...
import com.app.slidesum.databinding.FragmentSmallGameBinding
import com.app.slidesum.presenter.SmallGamePresenter
import com.app.slidesum.repository.SmallGameRepository
...
import com.app.slidesum.utils.Constants.Companion.SMALL_INITIAL_CAPACITY
...
class SmallGameFragment : Fragment() {
    ...
    private lateinit var binding: FragmentSmallGameBinding
    private val buttons: ArrayList<TextView> = ArrayList(SMALL_INITIAL_CAPACITY)
    private val presenter = SmallGamePresenter(this, SmallGameRepository())
    ...
    override fun onCreateView(
        ...
        binding = FragmentSmallGameBinding.inflate(layoutInflater)
