...
import com.app.slidesum.view.fragment.SmallGameFragment

class SmallGamePresenter(
    private val view: SmallGameFragment,
    private val repository: SmallGameRepository
) {
    fun getScore(): Int {
